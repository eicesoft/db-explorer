export default {
  updateTooltip(el: any, { value, modifiers }) {
          ...
          if (key === 'placement') {
            switch (val) {
              ...
              case 'right':
                ...
                targetEl.style.setProperty('--v-tooltip-top', '50%');
                targetEl.style.setProperty('--v-tooltip-translate', 'translate(10%, -50%)');
                if (value.displayArrow || modifiers.arrow) {
                  targetEl.style.setProperty(
                    '--v-tooltip-arrow-border-color',
  ...
  // hooks
  mounted(el: any, { value, dir, modifiers }) {
  ...
  updated(el: any, { value, dir, modifiers }) {
